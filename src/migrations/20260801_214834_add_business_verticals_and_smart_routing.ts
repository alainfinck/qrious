...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    DO $$ BEGIN
      ALTER TYPE "public"."enum_landing_pages_vertical" ADD VALUE 'chrd';
    EXCEPTION WHEN duplicate_object THEN null; END $$;

    DO $$ BEGIN
      ALTER TYPE "public"."enum_landing_pages_vertical" ADD VALUE 'corporate_event';
    EXCEPTION WHEN duplicate_object THEN null; END $$;

    DO $$ BEGIN
      ALTER TYPE "public"."enum_landing_pages_vertical" ADD VALUE 'ugc_retail';
    EXCEPTION WHEN duplicate_object THEN null; END $$;

    DO $$ BEGIN
      ALTER TYPE "public"."enum_landing_pages_vertical" ADD VALUE 'field_service';
    EXCEPTION WHEN duplicate_object THEN null; END $$;
