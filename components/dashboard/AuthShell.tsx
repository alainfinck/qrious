...
export function AuthShell({
  ...
  const features = [
    { color: 'bg-mq-signal', text: t('feature1') },
    { color: 'bg-mq-sky', text: t('feature2') },
    { color: 'bg-mq-coral', text: t('feature3') },
  ]
    ...
    <div className="relative flex min-h-dvh w-full overflow-hidden bg-mq-ink font-body text-white">
      ...
      <div className="relative hidden w-[46%] flex-col justify-between p-10 lg:flex xl:p-14">
        ...
        <div className="relative max-w-md">
          ...
          <BlurFade delay={0.15} inView>
            ...
            <h1 className="mt-4 font-display text-4xl font-bold leading-tight tracking-tight xl:text-5xl">
              {t('heroLine1')}
              <br />
              <span className="text-mq-signal">{t('heroLine2')}</span>
              <br />
              <span className="text-mq-coral">{t('heroLine3')}</span>
            </h1>
            <p className="mt-5 text-lg leading-relaxed text-white/55">{t('heroDescription')}</p>
          </BlurFade>
        ...
        <BlurFade delay={0.4} inView>
          <p className="text-sm text-white/35">{t('copyright', { year })}</p>
        </BlurFade>
      </div>
